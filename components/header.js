...
class Header extends React.Component {
 ...
 <span>Call Us:</span> <a href="tel:+14055141770"> (405) 514-1770</a>
  <div className="float-right "><a className="btn btn-primary right-button" href="">Contact Us</a></div>
</div>
<div className="top d-sm-none text-center">
 ...
 <i className="fa fa-male fa-1x" aria-hidden="true"></i><a href="/dropin">Drop In</a>
</div>
